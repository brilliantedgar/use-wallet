...
function _init$7() {
  _init$7 = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee5() {
    var _yield$import, WalletConnect, WalletConnectExtended;
    ...
    return runtime_1.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return import('@web3-react/walletconnect-v2');

          case 2:
            _yield$import = _context5.sent;
            WalletConnect = _yield$import.WalletConnect;

            WalletConnectExtended = /*#__PURE__*/function () {
              function WalletConnectExtended(args) {
                this.walletConnect = new WalletConnect(args);
              }

              var _proto = WalletConnectExtended.prototype;

              _proto.getProvider = /*#__PURE__*/function () {
                var _getProvider = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
                  return runtime_1.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          return _context.abrupt("return", this.walletConnect.provider);
              ...
              _proto.getAccount = /*#__PURE__*/function () {
                var _getAccount = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee2() {
                  var _this$walletConnect$p;

                  return runtime_1.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          return _context2.abrupt("return", ((_this$walletConnect$p = this.walletConnect.provider) == null ? void 0 : _this$walletConnect$p.accounts[0]) || null);
              ...
              _proto.activate = /*#__PURE__*/function () {
                var _activate = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(desiredChainId) {
                  return runtime_1.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          _context3.next = 2;
                          return this.walletConnect.activate(desiredChainId);

                        case 2:
                          return _context3.abrupt("return", this.getProvider());
              ...
              _proto.deactivate = /*#__PURE__*/function () {
                var _deactivate = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4() {
                  return runtime_1.wrap(function _callee4$(_context4) {
                    while (1) {
                      switch (_context4.prev = _context4.next) {
                        case 0:
                          return _context4.abrupt("return", this.walletConnect.deactivate());
              ...
              _proto.on = function on(event, callback) {
                var _this$walletConnect$p2;

                (_this$walletConnect$p2 = this.walletConnect.provider) == null ? void 0 : _this$walletConnect$p2.on(event, callback);
                return this;
              };

              _proto.off = function off(event, callback) {
                var _this$walletConnect$p3;

                (_this$walletConnect$p3 = this.walletConnect.provider) == null ? void 0 : _this$walletConnect$p3.off(event, callback);
                return this;
              };

              return WalletConnectExtended;
            }();
              ...
              web3ReactConnector: function web3ReactConnector(_ref) {
                ...
                return new WalletConnectExtended({
                  options: {
                    ...
                    showQrModal: true,
                    rpcMap: rpc,
                    chains: Object.keys(rpc).map(function (chainId) {
                      return parseInt(chainId);
                    })
                  },
                  actions: {
                    startActivation: function startActivation() {
                      return function () {};
                    },
...
const img$8 = require('./walletconnectv2.svg');
